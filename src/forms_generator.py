...
class GoogleFormsGenerator:
    ...
    def create_form(self, title, description="Quiz"):
        """
    ...
    def create_quiz_from_json(self, questions_data, form_title="Generated Quiz"):
        ...
        form_id, form_url = self.create_form(
            title=form_title,
            description=f"This quiz was generated by MindfuLLM, which tracks LLM usage and creates quizzes on the content to help ensure mastery. It contains {len(questions)} question(s). To learn more, visit https://github.com/teachathon/teachathon. Enjoy learning!"
        )
